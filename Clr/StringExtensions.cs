...
public static class StringExtensions
{
    ...
    public static int ComparableTo(this string source, string text)
    {
        ...
        return String.Compare(string1.ToString(), string2.ToString(), CultureInfo.InvariantCulture, CompareOptions.IgnoreNonSpace | CompareOptions.IgnoreCase);
